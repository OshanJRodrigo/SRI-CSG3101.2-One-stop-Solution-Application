...
--------------
 ...
 5.2 Via curl request:
    ...
    $ curl -X POST "http://0.0.0.0:8000/predict" -H "accept: application/json" -H "Content-Type: application/json" -d '{"id": "Ha3iJu77CxlrFm-vQRs_8g", "location": {"latitude": 32.241638, "longitude": -110.961819}}'