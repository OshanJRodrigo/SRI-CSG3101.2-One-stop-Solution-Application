  ...
  const renderReceiptTab = () => {
    return (
      <View>
        ...
        <View style={styles.receiptItem}>
          <Text style={styles.receiptLabel}>Pay Type:</Text>
      ...
      <View style={styles.body}>
        ...
        <View style={styles.statusContainer}>
          ...
          <TouchableOpacity 
            ...
            onPress={() => navigation.navigate('CustomerView')} // Navigate to Rate.js
          >
            <Text style={styles.rateButtonText}>view service</Text>
          </TouchableOpacity>
        </View>
        ...
        <View style={styles.employeeContainer}>
          ...
          <Text style={styles.employeeService}>{employeeService}</Text>
          <TouchableOpacity style={styles.contactButton}>
            <Text style={styles.contactButtonText}>Contact the Employee</Text>
          </TouchableOpacity>
        </View>
